...
sys.path.insert(0, "/Users/ayush/Desktop/ssg_eugene/EUGENE/ml_classify")
...
INPUT_FILE = "/Users/ayush/Desktop/ssg_eugene/EUGENE/diverse_sample_1k.parquet"
OUTPUT_FILE = "/Users/ayush/Desktop/ssg_eugene/EUGENE/labeled_sentences.parquet"
CHECKPOINT_FILE = "/Users/ayush/Desktop/ssg_eugene/EUGENE/labeling_checkpoint.json"
...
# Labeling Prompt
# ============================================================================
SYSTEM_PROMPT = """You are a job description classifier. For each sentence, classify it into exactly ONE of these categories:
...
If a sentence doesn't clearly fit any category (like location, contact info, boilerplate), classify it as the CLOSEST match or "Other".
...
def main():
    ...
    remaining_df = df[~df['job_id'].isin(processed_jobs)]
